...
export const indexDocument = (id, payload = { mode: 'provider' }) => request.post(`/api/knowledge-documents/${id}/index/`, payload)
...
export const getEmbeddingPolicy = () => request.get('/api/knowledge-search/policy/')
