...
export const retryRequirementAnalysisRound = (id, payload = {}) => request.post(`/api/requirement-documents/${id}/retry-round/`, payload, { timeout: STRUCTURED_ANALYSIS_TIMEOUT })
export const getRequirementAnalysisProgress = (id) => request.get(`/api/requirement-documents/${id}/analysis-progress/`)
export const cancelRequirementAnalysis = (id) => request.post(`/api/requirement-documents/${id}/cancel-analysis/`)
