...
def _validate_payload(payload: Mapping[str, Any], evidence_ids: set[str]) -> dict[str, Any]:
...
class OpenAICompatibleRuntime:
    ...
    def generate_structured(self, *, prompt: str, text: str, evidence: Sequence[Mapping[str, Any]]) -> Mapping[str, Any]:
        ...
        body = {
            ...
            "temperature": self.config.parameters.get("temperature", 0) if isinstance(self.config.parameters, dict) else 0,
