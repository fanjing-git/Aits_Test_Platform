...
from apps.requirement_analysis.stability import analysis_baseline, analysis_mapping_gaps, count_payload
...
class RequirementAnalysisRecordService:
    ...
    def confirm_analysis(
        ...
        *,
        ...
        if analysis.quality_status == RequirementAnalysis.QualityStatus.COMPLETE:
